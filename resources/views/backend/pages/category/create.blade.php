                ...
                <div class="general-label">
                    <form method="POST" action="{{ route('category.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="instruction" type="text" class="form-control @error('instruction') is-invalid @enderror" name="instruction" value="{{ old('instruction') }}" required autocomplete="instruction">
