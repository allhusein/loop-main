@extends('layouts.backend', ['title' => 'Log Activity'])

@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="">Log Activity</a></li>
@endsection
            ...
            <div class="card m-b-30">
                <div class="card-body">
                    <ul class="list-unstyled nav">
                        <li class="nav-item">
                            <h4 class="mt-0 header-title">Log Aktivitas Mahasiswa</h4>
                        </li>
                        @hasrole('superadmin')
