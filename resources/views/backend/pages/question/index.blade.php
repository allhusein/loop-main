                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('question.store') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" class="cat-id"
                                                data-catid="{{ $category->id }}" value="{{ $category->id }}">
                                            <input type="hidden" name="qid" class="cat-id"
                                                data-catid="{{ $q->id ? $q->id : '' }}" value="{{ $q->id ? $q->id : '' }}">
                                            <input type="hidden" class="true-answer">
                                            <div class="row">
                                                <div class="col-md-2">Soal</div>
                                                <div class="col-md-8">
                                                    <textarea name="question" class="w-100 summernote" rows="5">{{ $q->question }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-8" id="input-dinamis-jawaban-{{ $q->id }}">
                                                    @foreach ($q->answers as $a)
                                                        <div class="row align-items-center mt-2">
                                                            <div class="col-md-2 text-right itteration"
                                                                data-id="{{ $loop->iteration }}">{{ $loop->iteration }}
                                                            </div>
                                                            <div class="col-md-8">
                                                                <input class="w-100 answer" type="text"
                                                                    name="answer[{{ $a->id }}]"
                                                                    value="{{ old('answer') ? old('answer') : $a->answer }}">
                                                                @if ($a->is_true)
                                                                    <small>Jawaban Benar</small>
                                                                @endif
                                                            </div>
                                                            <div class="col-md-2">
                                                                <a href="{{ route('question.answer.check', $a->id) }}"
                                                                    class="text-primary btn-hapus-jawaban-{{ $a->id }}">
                                                                    @if ($a->is_true)
                                                                ...
                                                                <a href="{{ route('question.answer.delete', $a->id) }}"
                                                                    class="text-danger btn-hapus-jawaban-{{ $a->id }}">
                                                                    <i class="mdi mdi-delete"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div
                                                class="row mt-3 justify-content-center btn-tambah-jawaban-{{ $q->id }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('question.store') }}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">Soal</div>
                                                <div class="col-md-8">
                                                    <textarea name="question" class="w-100 summernote" rows="5"></textarea>
                                                </div>
                                            </div>
                                            <div class="row mt-2 align-items-center">
                                                <div class="col-md-2">Jawaban</div>
                                                <div class="col-md-8" id="input-dinamis-jawaban">
                                                    <div class="row align-items-center mt-2">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="w-100 answer" type="text" name="answer[]"
                                                                id="">
                                                        </div>
                                                        <div class="col-md-2">
                                                        </div>
